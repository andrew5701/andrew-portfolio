        ...
        <>
            ...
            <div className="flex">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-1">
                    <div className="col-start-1 row-start-1  bg-slate-200 p-2">
...
<path d="M28 28.9679C27.7869 31.6947 18.7877 32.2683 12.9274 31.8994C9.10432 31.6583 8.33812 31.0558 8.32691 31.047C11.9859 31.6402 18.1549 31.7482 23.1568 30.8225C27.5903 30.0016 28 28.9679 28 28.9679Z" fill="#5382A1"/>
                        ...
                        Java</div>
                    <div className="col-start-1 row-start-2 bg-slate-200 p-2">
                        Python</div>
                    <div className="col-start-2 row-start-1 bg-slate-200 p-2">JavaScript</div>
                    <div className="col-start-2 row-start-2 bg-slate-200 p-2">CSS</div>
                </div>
            </div>
        </>
    );
