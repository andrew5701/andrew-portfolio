...
export default function Home() {
  ...
  <div className="lg:max-w-lg lg:w-full pt-20 md:w-1/2 w-5/6 items-center justify-center flex m-auto">
      ...
      <div className="items-center">
        ...
        <div className='flex pb-4 justify-center gap-3 items-center' >


        <a  class="group no-underline bg-blue-400 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-blue-900 active:scale-105 transition" href="#contact" title="Contact me">
            Contact me here
        ...
        <a  class="group no-underline text-white bg-blue-400 hover:bg-blue-900 px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack" href='/files/Andrew_Krasuski_Resume.pdf' download="Andrew_Krasuski_Resume.pdf">
            Download Resume
