...
function AboutMe() {
  return (
    <section id="aboutme" className="py-10 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row items-center justify-center w-full mt-8 lg:space-x-8">
        <div className="lg:w-1/2">
          <h1 className="text-white text-3xl sm:text-4xl font-extrabold mb-4">About Me</h1>
          <p className="mb-5 text-left text-white px-5 lg:px-0 max-w-2xl text-base sm:text-lg">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <img
            className="rounded-md shadow border-white"
